...
function humanizeNumber(val) {
  ...
  var OPTS = {
    ...
    separator: (0, _is2["default"])(options) && (0, _isNotEmpty["default"])(options.separator) ? options.separator : '.',
    precision: (0, _is2["default"])(options) && Number.isInteger(options.precision) && options.precision >= 0 ? options.precision : 2,
    units: (0, _is2["default"])(options) && (Array.isArray(options.units) && options.units.length > 0 || options.units === !1) ? options.units ? options.units.filter(_is3["default"]) : !1 : ['', 'k', 'm', 'b', 't', 'q'],
    divider: (0, _is2["default"])(options) && Number.isInteger(options.divider) && options.divider > 1 ? options.divider : 1000,
