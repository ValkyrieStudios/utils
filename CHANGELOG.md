...
## [Unreleased]
### Improved
- **deps**: Upgrade @types/node to 22.19.21
- **deps**: Upgrade @vitest/coverage-v8 to 4.1.8
- **deps**: Upgrade typescript-eslint to 8.61.0
- **deps**: Upgrade vitest to @4.1.8
...
- **perf**: Improved performance of `hash/fnv1a` by ~100% by working with `Math.imul` instead of bitwise multiplication, allowing a single CPU instruction
