...
describe("Array", () => {
    ...
    describe("sort", () => {
        it ('does nothing and returns an empty array when passed a string', () => {
            let vals = fnStringValues();
            for (let el of vals) {
                expect(sort(el)).to.deep.equal([]);
            }
        });

        it ('does nothing and returns an empty array when passed a numeric value', () => {
            let vals = fnNumericValues();
            for (let el of vals) {
                expect(sort(el)).to.deep.equal([]);
            }
        ...
        it ('does nothing and returns an empty array when passed a boolean', () => {
            let vals = fnBooleanValues();
            for (let el of vals) {
                expect(sort(el)).to.deep.equal([]);
            }
        ...
        it ('does nothing and returns an empty array when passed a regex', () => {
            let vals = fnRegexValues();
            for (let el of vals) {
                expect(sort(el)).to.deep.equal([]);
            }
        ...
        it ('does nothing and returns an empty array when passed an object', () => {
            for (let el of [{bar:'foo'}, new Object(), Object.create(null)]) {
                expect(sort(el)).to.deep.equal([]);
            }
        });

        it ('does nothing and returns an empty array when passed a nullable', () => {
            let vals = fnNullables();
            for (let el of vals) {
                expect(sort(el)).to.deep.equal([]);
            }
        ...
        it ('does nothing and returns an empty array when passed a date', () => {
            let vals = fnDateValues();
            for (let el of vals) {
                expect(sort(el)).to.deep.equal([]);
            }
        ...
        it ('does nothing and returns an empty array when passed a function', () => {
            let vals = fnFunctionValues();
            for (let el of vals) {
                expect(sort(el)).to.deep.equal([]);
            }
        ...
        it ('does nothing and returns an empty array when passed an empty array', () => {
        ...
        it ('throws an error when passed a non-string, non-function by', () => {
            for (const el of [
                ...
                expect(e.message).to.eql('Sort by should be either a string or a function');
            }
        });
        ...
        it ('throws an error when passed a non-string, or a string that is not asc or desc', () => {
            for (const el of [
                ...
                let e;
                try {
                    sort([{test: 'hello'}], obj => obj.test, el);
                } catch (err) {
                    e = err;
                }
                assert.typeOf(e, 'Error');
                expect(e.message).to.eql('dir should be either asc or desc');
            }
        });

        it ('correctly when passed an array of objects with a string to sort by and default dir', () => {
            let out = sort([
                {test: 'Peter'},
                {test: 'Jack'},
                {test: 'Pony'},
        ...
        it ('correctly when passed an array of objects with a string to sort by and asc dir', () => {
            let out = sort([
                {test: 'Peter'},
                {test: 'Jack'},
                {test: 'Pony'},
        ...
        it ('correctly when passed an array of objects with a string to sort by and desc dir', () => {
            let out = sort([
                {test: 'Peter'},
                {test: 'Jack'},
                {test: 'Pony'},
        ...
        it ('correctly when passed an array of objects with a string to sort by and asc dir (benchmark array of 10000)', () => {
            let out = [];
            ...
            while (out.length > 0) {
                cursor = out.shift();
                expect(cursor.i).to.be.gt(i);
                i = cursor.i;
            }
        });

        it ('correctly when passed an array of objects with a string to sort by and desc dir (benchmark array of 10000)', () => {
            let out = [];
            for (let i = 0; i < 10000; i++) {
                out.push({i});
            }
            ...
            while (out.length > 0) {
                cursor = out.shift();
                expect(cursor.i).to.be.lt(i);
                i = cursor.i;
            }
        });

        it ('correctly when passed an array of objects with a string to sort by and asc dir (benchmark array of 20000)', () => {
            let out = [];
        ...
        it ('correctly when passed an array of objects with a string to sort by and desc dir (benchmark array of 20000)', () => {
            let out = [];
            for (let i = 0; i < 20000; i++) {
                out.push({i});
            }
        ...
        it ('correctly when passed an array of objects with a string to sort by and asc dir (benchmark array of 30000)', () => {
            let out = [];
        ...
        it ('correctly when passed an array of objects with a string to sort by and desc dir (benchmark array of 30000)', () => {
            let out = [];
            for (let i = 0; i < 30000; i++) {
                out.push({i});
            }
        ...
        it ('correctly filter out non-objects or empty objects when sorting with a string to sort by and desc dir', () => {
            let out = sort([
                ...fnRegexValues(),
                {test: 'Peter'},
                ...fnArrayValues(),
        ...
        it ('correctly filter out non-objects or empty objects when sorting with a string to sort by and asc dir', () => {
            let out = sort([
                ...fnRegexValues(),
                {test: 'Peter'},
                ...fnArrayValues(),
        ...
        it ('correctly when sorting with a function to sort by and asc dir', () => {
            let out = sort([
                {test: 'Peter'},
                {test: 'Jack'},
                {test: 'Pony'},
        ...
        it ('correctly when sorting with a function to sort by and desc dir', () => {
            let out = sort([
                {test: 'Peter'},
                {test: 'Jack'},
                {test: 'Pony'},
        ...
        it ('correctly filter out non-objects or empty objects when sorting with a function to sort by and desc dir', () => {
            let out = sort([
                ...fnRegexValues(),
                {test: 'Peter'},
                ...fnArrayValues(),
        ...
        it ('correctly filter out non-objects or empty objects when sorting with a function to sort by and asc dir', () => {
            let out = sort([
                ...fnRegexValues(),
                {test: 'Peter'},
                ...fnArrayValues(),
        ...
        it ('correctly position objects when sorting with a function and the function returns undefined to sort by and desc dir', () => {
            let out = sort([
                {test: 'Peter', uid: 1},
                {test: 'Jack', uid: 2},
                {test: 'Pony', uid: 3},
                ...
                {test: 'Bob', uid: 6},
                {test: 'Alice', uid: 7},
            ], el => el.test ? el.test.toLowerCase() : undefined, 'desc');
            expect(out).to.deep.equal([
                {test: 'Pony', uid: 3},
                {test: 'Peter', uid: 1},
                {test: 'Joe', uid: 5},
        ...
        it ('correctly position objects when sorting with a function and the function returns undefined to sort by and asc dir ', () => {
            let out = sort([
                {test: 'Peter', uid: 1},
                {test: 'Jack', uid: 2},
                {test: 'Pony', uid: 3},
                ...
                {test: 'Bob', uid: 6},
                {test: 'Alice', uid: 7},
            ], el => el.test ? el.test.toLowerCase() : undefined, 'asc');
            expect(out).to.deep.equal([
                {test: 'Alice', uid: 7},
                {test: 'Bob', uid: 6},
                {test: 'Jack', uid: 2},
        ...
        it ('correctly position objects when sorting with a sort key and the key is non-existent or undefined to sort by and desc dir', () => {
            let out = sort([
                {test: 'Peter', uid: 1},
                {test: 'Jack', uid: 2},
                {test: 'Pony', uid: 3},
        ...
        it ('correctly position objects when sorting with a sort key and the key is non-existent or undefined to sort by and asc dir ', () => {
            let out = sort([
                {test: 'Peter', uid: 1},
                {test: 'Jack', uid: 2},
                {test: 'Pony', uid: 3},
        ...
        it ('correctly position objects when sorting with a sort key and filter out those which wouldnt have anything to sort by when using {nokey_hide: true} sort by and asc dir ', () => {
            let out = sort([
                {test: 'Peter', uid: 1},
                {test: 'Jack', uid: 2},
                {test: 'Pony', uid: 3},
        ...
        it ('correctly position objects when sorting with a sort key and the key is non-existent or undefined to sort by and asc dir and allow positioning the nokey ones through nokey_atend', () => {
            let out = sort([
                {test: 'Peter', uid: 1},
                {test: 'Jack', uid: 2},
                {test: 'Pony', uid: 3},
        ...
        it ('correctly position objects when sorting with a sort key and the key is non-existent or undefined to sort by and asc dir and allow filtering out ahead of time with filter_fn', () => {
            let out = sort([
                {test: 'Peter', uid: 1},
                {test: 'Jack', uid: 2},
                {test: 'Pony', uid: 3},
        ...
        it ('correctly position objects when sorting with a sort key and the key is non-existent or undefined to sort by and asc dir and allow filtering out ahead of time with filter_fn (different key)', () => {
            let out = sort([
                {test: 'Peter', uid: 1},
                {test: 'Jack', uid: 2},
                {test: 'Pony', uid: 3},
        ...
        it ('keep references intact to elements in the array', () => {
            let arr = [
                {test: 'Peter', uid: 1},
                {test: 'Jack', uid: 2},
                {test: 'Pony', uid: 3},
            ...
            let out = sort(arr, 'uid', 'desc', {nokey_atend: false, filter_fn: el => isObject(el) && isNotEmptyString(el.test)});
            expect(out).to.deep.equal([
                {test: 'Alice', uid: 7},
                {test: 'Bob', uid: 6},
                {test: 'Joe', uid: 5},
            ...
            expect(arr[6].test).to.eql('Alice rocks');
        });
