...
function diff(val_a, val_b) {
  ...
  if (!(0, _is["default"])(val_a) || !(0, _is["default"])(val_b)) throw new TypeError('Diff requires date objects for both values');
  if (key !== !1 && typeof key !== 'string') throw new TypeError('Key needs to be a string or false');
