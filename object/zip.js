...
function zip() {
  ...
  if (!(0, _is["default"])(keys)) throw new TypeError('Please pass an array as value for keys');
  if (!(0, _is["default"])(values) && values !== !1) throw new TypeError('Please pass an array or false as value for values');
